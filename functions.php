...
function oasiscode_scripts() {
	...
	wp_enqueue_script( 'slicknav-js', get_template_directory_uri() . '/js/jquery.slicknav.js', array('jquery'), '', true );
...
function add_google_fonts() {
	wp_register_style('googleFonts', 'http://fonts.googleapis.com/css?family=Roboto+Slab:400,300|Roboto:400,500,300,700');
